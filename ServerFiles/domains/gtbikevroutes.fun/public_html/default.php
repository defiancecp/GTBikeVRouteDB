...
<div class="container-fluid" >
  ...
  <!-- <style>body {background-image:URL("images/gtbv_banr.jpg");}</style> -->
	...
	<b>You can now view your GT Bike V rides on the GTA V Map!  <a class="link" href="https://gtbikevroutes.fun/MapPreview.php" >Metric</a> or <a class="link" href="https://gtbikevroutes.fun/MapPreview.php?met=Imperial" >Imperial</a> version.</b>
	</p>
  </div>
</div>
    <?php
